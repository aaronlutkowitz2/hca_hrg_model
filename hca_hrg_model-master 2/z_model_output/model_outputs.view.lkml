view: model_outputs {
  ...
  dimension: avg_overtime_hours {
    type: number
    sql: round(${TABLE}.avg_overtime_hours,1) ;;
    value_format_name: decimal_1
  }
  ...
  dimension: avg_pto_hours {
    type: number
    sql: round(${TABLE}.avg_pto_hours,1) ;;
    value_format_name: decimal_1
  }
  ...
  dimension: avg_worked_hours {
    type: number
    sql: round(${TABLE}.avg_worked_hours,1) ;;
    value_format_name: decimal_1
  }
  ...
  dimension: hire_tenure {
    type: number
    sql: round(${TABLE}.hire_tenure / 12, 1) ;;
    value_format_name: decimal_1
  }
  ...
  dimension: pos_tenure {
    type: number
    sql: round(${TABLE}.pos_tenure / 12, 1) ;;
    value_format_name: decimal_1
  }
  ...
  dimension: avg_ot_hours_new {
    view_label: "New"
    type: string
    sql:
    case
      when ${avg_overtime_hours} = 0 then 'A - No OT'
      when ${avg_overtime_hours} > 0 AND ${avg_overtime_hours} < 4  then 'B - 1-4 Hours OT'
      else 'C - 4+ Hours OT'
    end
